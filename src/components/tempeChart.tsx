      ...
      <div className="flex flex-1 flex-col items-center justify-center">
        <div className="text-center mb-3 sm:mb-6">
          ...
          <div className="flex items-baseline justify-center">
            <span className="text-5xl sm:text-7xl font-bold text-[#4ade80]">{sensorData.temperatura}</span>
            <span className="text-2xl sm:text-4xl text-[#4ade80] ml-2">°F</span>
          </div>
        </div>
        <Thermometer className="w-8 h-6 sm:w-10 sm:h-8 text-gray-600 mb-3 sm:mb-6" />
        <p className="text-xs sm:text-sm text-gray-400">{sensorData.ultimaActualizacion}</p>
      </div>
